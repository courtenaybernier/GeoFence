(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))l(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&l(c)}).observe(document,{childList:!0,subtree:!0});function r(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function l(n){if(n.ep)return;n.ep=!0;const o=r(n);fetch(n.href,o)}})();let i,m,d,a=[],f=!1,u=!1,s=null;function h(){if(typeof L>"u"){setTimeout(h,100);return}I(),v(),b(),setInterval(b,5e3)}document.addEventListener("DOMContentLoaded",h);function I(){const e=document.createElement("style");e.textContent=`
  ...
  `,document.getElementById("btnDraw").onclick=B,document.getElementById("btnFinish").onclick=C,document.getElementById("btnMonitor").onclick=M,document.getElementById("btnReset").onclick=x}function v(){i=L.map("map").setView([37.7749,-122.4194],13),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19,attribution:"© OpenStreetMap"}).addTo(i),i.on("click",E)}function b(){if(!navigator.geolocation){alert("Geolocation not supported");return}navigator.geolocation.getCurrentPosition(e=>{const t=e.coords.latitude,r=e.coords.longitude;document.getElementById("coords").textContent=`📍 Lat: ${t.toFixed(6)}, Lng: ${r.toFixed(6)}`,m?m.setLatLng([t,r]):(m=L.marker([t,r]).addTo(i),i.setView([t,r],16)),u&&k(t,r)},e=>console.error("Location error:",e),{enableHighAccuracy:!0})}function E(e){if(!f)return;const t=[e.latlng.lat,e.latlng.lng];a.push(t),L.circleMarker(e.latlng,{radius:5,fillColor:"#667eea",color:"#667eea",weight:2,fillOpacity:.8}).addTo(i),a.length>1&&L.polyline(a,{color:"#667eea",weight:2}).addTo(i),document.getElementById("status").textContent=`${a.length} point${a.length>1?"s":""} added`}function B(){f=!0,a=[],d&&(i.removeLayer(d),d=null),document.getElementById("btnDraw").disabled=!0,document.getElementById("btnFinish").disabled=!1,document.getElementById("btnMonitor").disabled=!0,document.getElementById("status").textContent="Click on map to add boundary points (minimum 3)"}function C(){if(a.length<3){alert("You need at least 3 points to create a boundary!");return}f=!1,i.eachLayer(e=>{(e instanceof L.CircleMarker||e instanceof L.Polyline)&&i.removeLayer(e)}),d=L.polygon(a,{color:"#4caf50",fillColor:"#4caf50",fillOpacity:.2,weight:2}).addTo(i),document.getElementById("btnDraw").disabled=!1,document.getElementById("btnFinish").disabled=!0,document.getElementById("btnMonitor").disabled=!1,document.getElementById("status").textContent="Boundary created! Ready to start monitoring."}function M(){if(!d){alert("Please create a boundary first!");return}u=!0,d.setStyle({color:"#f44336",fillColor:"#f44336"}),document.getElementById("btnDraw").disabled=!0,document.getElementById("btnMonitor").disabled=!0,document.getElementById("status").textContent="🔴 Monitoring active - tracking your location...",s=setInterval(b,2e3)}function k(e,t){if(!d||!u)return;const r=L.latLng(e,t);D(r,a)||(clearInterval(s),u=!1,alert("⚠️ Your device has left the boundary and will be wiped clean!"),setTimeout(x,1e3))}function D(e,t){const r=e.lat,l=e.lng;let n=!1;for(let o=0,c=t.length-1;o<t.length;c=o++){const p=t[o][0],g=t[o][1],w=t[c][0],y=t[c][1];g>l!=y>l&&r<(w-p)*(l-g)/(y-g)+p&&(n=!n)}return n}function x(){s&&(clearInterval(s),s=null),f=!1,u=!1,a=[],i.eachLayer(e=>{(e instanceof L.Polygon||e instanceof L.CircleMarker||e instanceof L.Polyline)&&i.removeLayer(e)}),d=null,document.getElementById("btnDraw").disabled=!1,document.getElementById("btnFinish").disabled=!0,document.getElementById("btnMonitor").disabled=!0,document.getElementById("status").textContent='Click "Start Drawing" to create a boundary'}
